...
welcomepage = (function (input) {
  ...
  function createhue(middle, elapsed) {
    ...
    middle.fillStyle = 'white';
    middle.font = '60px monospace';
    alignText(middle, title, y);

    middle.fillStyle = color;
    middle.font = '24px monospace';
    alignText(middle,'Shoot the Bird to Earn Points.', y + 40);
    alignText(middle,'If you miss you lose points.', y + 80);
alignText(middle,'Click Anywhere to Start!', y + 120);
  }
